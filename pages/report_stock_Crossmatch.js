...
const Report_stock_Crossmatch = () => {
  ...
  const Search_data = async () => {
    ...
    const result = await api.get("/Get_report_xm", {
      params: {
  ...
  const handlerClickDownloadButton = async () => {
    ...
    let name_doc = frmData.doc_code === "" ? "" : `Doctor:${doc_name}`;
    let name_ward = frmData.ward_code === "" ? "" : `Ward:${ward_name}`;
    ...
    a.download = `รายงาน Crossmatch ประจำวันที่ ${date}.` + format;
    a.click();
    a.remove();
  };
  return (
    <>
      <Layout keyTab="report_stock_Crossmatch">
        <div>
          <Head>
            <title>SIBSOFT : รายงาน Crossmatch</title>
        ...
        <Row justify="center">
          <Col span={24} style={{ padding: "10px" }}>
            <Card style={{ minHeight: "90vh" }}>
              <Tabs type="card">
                <TabPane tab="รายงาน Crossmatch" key="1">
...
export default Report_stock_Crossmatch;
...
const PrintDetail = ({
  ...
  return (
    ...
    >
      <br />
      <Row justify="center">
        <h style={{ fontSize: "18px" }}>รายงาน Crossmatch</h>
      </Row>
