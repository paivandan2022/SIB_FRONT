...
const Report_stock_Separates_Bloods = () => {
  ...
  const Search_data = async () => {
    ...
    const result = await api.get("/data_report_stock_Separates_Bloods", {
      params: {
  ...
  const handlerClickDownloadButton = async () => {
    ...
    workbook.addWorksheet("รายงานปั่นแยกถุงเลือด");
    const worksheet = workbook.getWorksheet("รายงานปั่นแยกถุงเลือด");
    ...
    a.download = `รายงานปั่นแยกถุงเลือด  ${date}.` + format;
    a.click();
    a.remove();
  };
  return (
    <>
      <Layout keyTab="report_stock_Separates_Bloods">
        <div>
          <Head>
            <title>SIBSOFT : รายงานปั่นแยกถุงเลือด</title>
        ...
        <Row justify="center">
          <Col span={24} style={{ padding: "10px" }}>
            <Card style={{ minHeight: "90vh" }}>
              <Tabs type="card">
                <TabPane tab="ปั่นแยกถุงเลือด" key="1">
...
export default Report_stock_Separates_Bloods;
...
const PrintDetail = ({
  ...
  return (
    ...
    >
      <br />
      <Row justify="center">
        <h style={{ fontSize: "18px" }}>รายงานปั่นแยกถุงเลือด</h>
      </Row>
