...
const Report_daily_CT_ratio = () => {
  ...
  const Search_data = async () => {
    ...
    const result = await api.get("/Get_daily_CT_ratio", {
      params: {
  ...
  const columns = [
    ...
    },
    {
      ...
      align: "center",
      width: "5%",
      render: (text, record) => (record.ct == null ? 0 : record.ct),
    },
  ];
  ...
  const handlerClickDownloadButton = async () => {
    ...
    workbook.addWorksheet("รายงานCT_ratio");
    const worksheet = workbook.getWorksheet("รายงานCT_ratio");
    ...
    for (let i = 0; i < data_table.length; i++) {
      dataTest[i] = {
        ...
        c7: Number(data_table[i].xm),
        c8: Number(data_table[i].tran),
        c9: Number(data_table[i].rel),
        c10: data_table[i].ps,
        c11: data_table[i].ct == null ? 0 : Number(data_table[i].ct),
      };
    }
    ...
    a.download = `รายงานCT_ratio  ${date}.` + format;
    a.click();
    a.remove();
  };
  ...
  return (
    <>
      <Layout keyTab="report_daily_CT_ratio">
        <div>
          <Head>
            <title>SIBSOFT : รายงาน C/T ratio</title>
        ...
        <Row justify="center">
          <Col span={24} style={{ padding: "10px" }}>
            <Card style={{ minHeight: "90vh" }}>
              <Tabs type="card">
                <TabPane tab="รายงาน C/T ratio" key="1">
...
export default Report_daily_CT_ratio;
...
const PrintDetail = ({
  ...
  return (
    ...
    >
      <br />
      <Row justify="center">
        <h style={{ fontSize: "18px" }}>รายงาน C/T ratio</h>
      </Row>
