...
const Report_stock_payblood_return = () => {
  ...
  const Search_data = async () => {
    ...
    const result = await api.get("/Get_report_trans_revers", {
      params: {
  ...
  const handlerClickDownloadButton = async () => {
    ...
    a.download = `รายงานการจ่ายเลือด-คืน ประจำวันที่ ${date}.` + format;
    a.click();
    a.remove();
  };
  ...
  return (
    <>
      <Layout keyTab="report_stock_payblood_return">
        <div>
          <Head>
            <title>SIBSOFT : รายงาน จ่ายเลือด-คืน</title>
        ...
        <Row justify="center">
          <Col span={24} style={{ padding: "10px" }}>
            <Card style={{ minHeight: "90vh" }}>
              <Tabs type="card">
                <TabPane tab="รายงานการจ่ายเลือด-คืน" key="1">
...
export default Report_stock_payblood_return;
...
const PrintDetail = ({
  ...
  return (
    ...
    >
      <br />
      <Row justify="center">
        <h style={{ fontSize: "18px" }}>รายงานการจ่ายเลือด - คืน</h>
      </Row>
